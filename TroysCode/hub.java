...
public class hub
	{
		 ...
		 * {@link Frame} Class.
		 */
		public static final String programName = "PROJECT TITLE HERE";
		/**
		 * This is added to the title of the program's frame in the
		 ...
		 */
		public static final PongGame pongGame = new PongGame();
		...
		public static void main(String[] args)
			{
				frame.startFrame();
				hub.renderer.setStartRenderableObject(hub.pongGame);
				hub.renderer.begin();
			}
	}
